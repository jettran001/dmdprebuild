...
/*
    ...
    │   ├── contracts.rs           -> Quản lý các smart contracts (ContractRegistry, ContractInterface, ContractManager) [liên quan: blockchain.rs, erc20.rs, erc721.rs, erc1155.rs]
    │   ├── erc20.rs               -> Triển khai ERC20 token standard (Erc20Contract, TokenInfo, Erc20ContractBuilder) [liên quan: contracts.rs, blockchain.rs]
    │   ├── erc721.rs              -> Triển khai ERC721 NFT standard (Erc721Contract, NftInfo, Erc721ContractBuilder) [liên quan: contracts.rs, blockchain.rs]
    │   ├── erc1155.rs             -> Triển khai ERC1155 Multi-Token standard (Erc1155Contract, Erc1155ContractBuilder) [liên quan: contracts.rs, blockchain.rs]
    ...
    - defi::blockchain/non_evm/diamond.rs cung cấp Diamond blockchain provider với hỗ trợ các token chuẩn DRC-20, DRC-721, DRC-1155
