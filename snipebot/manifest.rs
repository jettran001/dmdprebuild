...
//! │   │   ├── utils.rs           // Unified utilities for all trade logic
...
//! │   │   │   ├── strategy.rs    // Chiến lược giao dịch (DCA, Grid, TWAP, TSL)
...
//!   - **strategy.rs**: Các chiến lược giao dịch (DCA, Grid, TWAP, TSL, TP/SL động).
//!   - **trade_execution.rs**: Logic thực thi giao dịch, đóng gói giao dịch.
//!   - **utils.rs**: Các tiện ích riêng cho smart trade.
