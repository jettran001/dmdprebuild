...
/// Cấu hình cảnh báo cho SmartTrade
#[derive(Debug, Clone)]
pub struct AlertSettings {
    /// Bật/tắt cảnh báo
    pub enabled: bool,
    
    /// Gửi cảnh báo khi đạt mức lợi nhuận
    pub profit_threshold: f64,
    
    /// Gửi cảnh báo khi đạt mức lỗ
    pub loss_threshold: f64,
    
    /// Gửi cảnh báo khi giá thay đổi đột ngột (%)
    pub price_change_threshold: f64,
    
    /// Danh sách kênh nhận cảnh báo (Telegram, Discord, Email)
    pub notification_channels: Vec<String>,
    
    /// Khoảng thời gian tối thiểu giữa các cảnh báo (giây)
    pub min_alert_interval_seconds: u64,
    
    /// Bật/tắt cảnh báo lỗi mạng
    pub network_alerts: bool,
    
    /// Bật/tắt cảnh báo mức độ ưu tiên cao
    pub high_priority_alerts: bool,
    
    /// Bật/tắt cảnh báo mức độ ưu tiên trung bình
    pub medium_priority_alerts: bool,
    
    /// Bật/tắt cảnh báo mức độ ưu tiên thấp
