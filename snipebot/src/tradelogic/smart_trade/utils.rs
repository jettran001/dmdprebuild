...
pub async fn execute_trade_with_params(
    ...
    let transaction_hash = match tx_result {
        ...
        Err(e) => {
            ...
            return Ok(TradeResult {
                ...
                execution_price: Some(current_price),
                token_amount: None,
                gas_cost: None,
                execution_time_ms: 0,
    ...
    updated_tracker.updated_at = now as i64;
    updated_tracker.buy_tx_hash = Some(transaction_hash.clone());
    updated_tracker.buy_price = Some(current_price);
    ...
    let result = TradeResult {
        ...
        error: None,
        execution_price: Some(current_price),
        token_amount: Some(params.amount),
        gas_cost: Some(5.0), // Placeholder value
        execution_time_ms: 0,
        additional_info: HashMap::new(),
    };
