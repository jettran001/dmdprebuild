...
impl TradeCoordinatorImpl {
    ...
    pub async fn start(&self) -> Result<()> {
        // Clone self for background tasks
        ...
        tokio::spawn(async move {
            loop {
                ...
                if let Err(e) = cleanup_coordinator.cleanup_expired_opportunities().await {
        ...
        tokio::spawn(async move {
            loop {
                ...
                if let Err(e) = stats_coordinator.update_statistics().await {
